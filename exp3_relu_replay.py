import torch
from model import init_single_and_ensemble, DeepRelu
from exp1_replay import Trainer
...
class Trainer(Trainer):
    ...
    def __init__(self, path):
        super().__init__(path)
        self.single, self.ensemble = init_single_and_ensemble(ensemble_size=5, model_class=DeepRelu)
...
if __name__ == '__main__':
    ...
    for run in range(10):
        trainer = manager.Trainer(f'exp/exp3_relu_replay/run{run}')
